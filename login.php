...
<head>
    ...
    <title>Raiani Mendes | Login</title>
    <link rel="icon" href="assets/img/landing/favicon.png">
    <!-- fontawesome icon -->
    <link rel="stylesheet" href="assets/fonts/fontawesome/css/fontawesome-all.min.css">
    <!-- material design icon -->
    <link rel="stylesheet" href="assets/fonts/material/material-icons.css">
    <!-- animation css -->
            ...
            <div class="card">
                <div class="row no-gutters">
                    <div
                        ...
                        <img src="assets/img/landing/slogan.jpeg" alt="lock images" class="img-fluid">
                    </div>
